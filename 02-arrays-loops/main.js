...
while(notAnswer){
    switch (userChise) {
        ...
        case '2':
            ...
            break
        default:
            alert('Ви вели неправильний варіан')        
    }
}
...
for (let i = 0; i < movies.length; i++) {
    ...
    // 
    desciptionText += "<article><h3>" + movies[i][0] +"</h3><p>" + movies[i][2] +"2 </p></article>"
}

movieList += li + "</ul"

let desciptionMovies = '<main><h2>Опис фільмів<h2><hr>' + desciptionText +'</main>' 


header += movieList + '</header>' + desciptionMovies;
